...
public static class RegisterCatalog
{
    ...
    [
        ...
        // 协议表按 514、513 的顺序定义当前报警；地址顺序不能擅自排序。
        new("当前报警", [514, 513], RegisterDataType.UInt32, string.Empty, ValueTransform.AlarmBits, FormatDescription: "见 5.3", ProtocolConfirmed: false),
        new("当前故障/报警相别和类型", [515], RegisterDataType.UInt16, string.Empty, ValueTransform.CurrentEvent, FormatDescription: "见 5.4"),
        new("当前故障数据 0", [516], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 1", [517], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 2", [518], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 3", [519], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 4", [520], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 5", [521], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 6", [522], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("当前故障数据 7", [523], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
    ];
    ...
    [
        ...
        new("故障数据 0", [772], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 1", [773], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 2", [774], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 3", [775], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 4", [776], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 5", [777], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 6", [778], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
        new("故障数据 7", [779], RegisterDataType.UInt16, string.Empty, ValueTransform.RawUnconfirmed, FormatDescription: "见 5.5"),
    ...
    private static RegisterDefinition UInt32(
        ...
        string unit,
        decimal multiplier) =>
        new(name, [first, second], RegisterDataType.UInt32, unit, ValueTransform.Multiply, multiplier, $"×{multiplier}", false);
}
