...
当前覆盖 CRC 标准帧、分段响应、高低字节、CRC 一次重试、设备异常不重试、uint32 两种字序、`[514,513]`、BW1/BW3 额定电流序值映射、电流变比 1/2 及非法序值、百分比原值展示、事件数据 0、非法 BCD、续寄存器去重、Excel 四列约束、模拟器 03H/06H 与错误 CRC。
